...
function getStepContent(step, handleChange, values) {
  switch (step) {
    case 0:
      return <Personal handleChange={handleChange} values={values} />;
    case 1:
      return <Professional handleChange={handleChange} values={values} />;
    case 2:
      return <Services handleChange={handleChange} values={values} />;
      case 3:
      return <Portfolio handleChange={handleChange} values={values} />;
    default:
      return 'Unknown step';
  }
}
